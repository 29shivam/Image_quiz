...
import 'package:image_level_app/data.dart';
import 'package:image_level_app/questions.dart';
import 'package:image_level_app/result.dart';
          ...
          children: <Widget>[
            ...
            Column(
              children: <Widget>[
                Container(
                  child: Image(
                    image: AssetImage('${_questions[index].getImage()}'),
                  ),
                ),
              ],
            ),
